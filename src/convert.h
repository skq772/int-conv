...
namespace convert
{
	...
	// Parameters:
	// - const char* number - binary represented in C string;
	// - u8 maximum_length - the maximum size the C string may have;
	...
	// Parameters:
	// - const char* number - C string with float represented in binary;
	...
	// Parameters:
	// - const char* number - C string with double represented in binary;
